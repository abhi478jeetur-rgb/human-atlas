...
import {Activity,ArrowUpRight,Bookmark,Camera,ChevronRight,Focus,Info,Keyboard,Layers3,Pause,RotateCcw,RotateCw,Search,Trash2,Volume2,X} from 'lucide-react';
...
export default function Home(){
 ...
 useEffect(()=>{
  const key=(e:KeyboardEvent)=>{
   ...
   else if(e.key==='Escape'){setPanel(null);setDetails(false);setAbout(false);setHelp(false);setBookmarksOpen(false);}
  };
